...
class P1Q7HalfChannelsNet(nn.Module):
    def __init__(self):
        super(P1Q7HalfChannelsNet, self).__init__()
        # TODO Implement me
...
class P1Q7DoubleChannelsNet(nn.Module):
    def __init__(self):
        super(P1Q7DoubleChannelsNet, self).__init__()
        # TODO Implement me
        raise NotImplementedError
...
def chooseModel(model_name='default', cuda=True):
    ...
    if model_name == 'default' or model_name == 'P1Q7DefaultChannelsNet':
        model = Net()
    elif model_name == 'P1Q7HalfChannelsNet':
        model = P1Q7HalfChannelsNet()
    elif model_name == 'P1Q7HalfChannelsNet':
        model = P1Q7DoubleChannelsNet()
    else:
